...
vim.keymap.set('n', '<leader>jy', function() vim.cmd(':Journal year') end, {desc='Open yearly journal'})
vim.keymap.set('n', '<leader>jn', function() vim.cmd(':Journal week +1') end, {desc='Journal next week'})
